...
namespace DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static DataTable FindByPage(object obj, string start, string limit, string conditions)
        {
            ...
            string sql = "select top " + limit + " * from " + ModelInfo[0] + " where " + ModelInfo[1] + " not in(select top " + start + " " + ModelInfo[1] + " from " + ModelInfo[0] + " order by " + ModelInfo[1] + " desc) order by " + ModelInfo[1] + " desc";
            if (conditions.Trim().Length > 0)
            {
                sql = "select top " + limit + " * from " + ModelInfo[0] + " where " + ModelInfo[1] + " not in(select top " + start + " " + ModelInfo[1] + " from " + ModelInfo[0] + "  where " + conditions + " order by " + ModelInfo[1] + " desc) and  (" + conditions + ")  order by " + ModelInfo[1] + " desc";
            }
            return Query(sql).Tables[0];
        }
        /// <summary>
